...
F5 "P1_Alert" O L 1100 1100 50 
F6 "V+12V" I L 1100 775 50 
F7 "P1_EN_ACM" I R 2125 675 50 
F8 "P1_EN_AUX" I R 2125 775 50 
F9 "P1_OUT" O R 2125 975 50 
F10 "P1_MOS_SENSE" O R 2125 875 50 
$EndSheet
...
P2_MOS_SENSE
Text GLabel 2225 1450 2    50   Input ~ 0
P2_EN_ACM
Wire Wire Line
	1000 1875 1100 1875
...
F4 "P3_Alert" O L 1100 2625 50 
F5 "P3_SDA" B L 1100 2425 50 
F6 "P3_SLC" I L 1100 2525 50 
F7 "P3_EN_ACM" I R 2125 2200 50 
F8 "P3_EN_AUX" I R 2125 2300 50 
F9 "P3_MOS_SENSE" O R 2125 2400 50 
F10 "P3_OUT" O R 2125 2500 50 
$EndSheet
Text GLabel 2225 2400 2    50   Input ~ 0
P3_MOS_SENSE
Text GLabel 2225 2200 2    50   Input ~ 0
P3_EN_ACM
Wire Wire Line
	1000 2625 1100 2625
...
P4_MOS_SENSE
Text GLabel 2225 2950 2    50   Input ~ 0
P4_EN_ACM
Wire Wire Line
	1000 3375 1100 3375
...
F4 "P5_Alert" O L 1100 4125 50 
F5 "P5_SDA" B L 1100 3925 50 
F6 "P5_SLC" I L 1100 4025 50 
F7 "P5_EN_ACM" I R 2125 3700 50 
F8 "P5_EN_AUX" I R 2125 3800 50 
F9 "P5_MOS_SENSE" O R 2125 3900 50 
F10 "P5_OUT" O R 2125 4000 50 
$EndSheet
Text GLabel 2225 3900 2    50   Input ~ 0
P5_MOS_SENSE
Text GLabel 2225 3700 2    50   Input ~ 0
P5_EN_ACM
Wire Wire Line
	1000 4125 1100 4125
...
F4 "P6_Alert" O L 1100 4875 50 
F5 "P6_SDA" B L 1100 4675 50 
F6 "P6_SLC" I L 1100 4775 50 
F7 "P6_EN_ACM" I R 2125 4450 50 
F8 "P6_EN_AUX" I R 2125 4550 50 
F9 "P6_MOS_SENSE" O R 2125 4650 50 
F10 "P6_OUT" O R 2125 4750 50 
$EndSheet
Text GLabel 2225 4650 2    50   Input ~ 0
P6_MOS_SENSE
Text GLabel 2225 4450 2    50   Input ~ 0
P6_EN_ACM
Wire Wire Line
	1000 4875 1100 4875
...
P7_MOS_SENSE
Text GLabel 2225 5200 2    50   Input ~ 0
P7_EN_ACM
Wire Wire Line
	1000 5625 1100 5625
...
Wire Notes Line
	1750 6875 1750 7775
Text GLabel 2225 675  2    50   Input ~ 0
P1_EN_ACM
$Sheet
...
F4 "P2_Alert" O L 1100 1875 50 
F5 "P2_SDA" B L 1100 1675 50 
F6 "P2_SLC" I L 1100 1775 50 
F7 "P2_EN_ACM" I R 2125 1450 50 
F8 "P2_EN_AUX" I R 2125 1550 50 
F9 "P2_MOS_SENSE" O R 2125 1650 50 
F10 "P2_OUT" O R 2125 1750 50 
$EndSheet
$Sheet
...
F4 "P4_Alert" O L 1100 3375 50 
F5 "P4_SDA" B L 1100 3175 50 
F6 "P4_SLC" I L 1100 3275 50 
F7 "P4_EN_ACM" I R 2125 2950 50 
F8 "P4_EN_AUX" I R 2125 3050 50 
F9 "P4_MOS_SENSE" O R 2125 3150 50 
F10 "P4_OUT" O R 2125 3250 50 
$EndSheet
$Sheet
...
F4 "P7_Alert" O L 1100 5625 50 
F5 "P7_SDA" B L 1100 5425 50 
F6 "P7_SLC" I L 1100 5525 50 
F7 "P7_EN_ACM" I R 2125 5200 50 
F8 "P7_EN_AUX" I R 2125 5300 50 
F9 "P7_MOS_SENSE" O R 2125 5400 50 
F10 "P7_OUT" O R 2125 5500 50 
$EndSheet
Wire Wire Line
	1000 1675 1100 1675
...
Wire Wire Line
	2225 775  2125 775 
Text GLabel 2225 775  2    50   Input ~ 0
P1_EN_AUX
Wire Wire Line
	2225 1550 2125 1550
Text GLabel 2225 1550 2    50   Input ~ 0
P2_EN_AUX
Wire Wire Line
	2225 2300 2125 2300
Text GLabel 2225 2300 2    50   Input ~ 0
P3_EN_AUX
Wire Wire Line
	2225 3050 2125 3050
Text GLabel 2225 3050 2    50   Input ~ 0
P4_EN_AUX
Wire Wire Line
	2225 3800 2125 3800
Text GLabel 2225 3800 2    50   Input ~ 0
P5_EN_AUX
Wire Wire Line
	2225 4550 2125 4550
Text GLabel 2225 4550 2    50   Input ~ 0
P6_EN_AUX
Wire Wire Line
	2225 5300 2125 5300
Text GLabel 2225 5300 2    50   Input ~ 0
P7_EN_AUX
...
P2_MOS_SENSE
Text GLabel 9275 3475 0    50   Input ~ 0
P2_EN_ACM
Text GLabel 6800 3650 2    50   Input ~ 0
P3_MOS_SENSE
Text GLabel 9275 3775 0    50   Input ~ 0
P3_EN_ACM
...
P5_MOS_SENSE
Text GLabel 9275 3275 0    50   Input ~ 0
P5_EN_ACM
Text GLabel 6800 3350 2    50   Input ~ 0
P6_MOS_SENSE
Text GLabel 6800 3250 2    50   Input ~ 0
P7_MOS_SENSE
Text GLabel 9275 3875 0    50   Input ~ 0
P7_EN_ACM
Text GLabel 9275 3575 0    50   Input ~ 0
P1_EN_ACM
Text GLabel 4300 6200 1    50   Input ~ 0
P7_OUT
Text GLabel 4700 6200 1    50   Input ~ 0
P6_OUT
Text GLabel 4800 6200 1    50   Input ~ 0
P5_OUT
Text GLabel 4200 6200 1    50   Input ~ 0
P4_OUT
Text GLabel 4500 6200 1    50   Input ~ 0
P3_OUT
Text GLabel 4600 6200 1    50   Input ~ 0
P2_OUT
Text GLabel 4400 6200 1    50   Input ~ 0
P1_OUT
Text GLabel 9275 3375 0    50   Input ~ 0
P3_EN_AUX
Text GLabel 9275 3975 0    50   Input ~ 0
FP_ENABLE_ACM
Text GLabel 4900 6200 1    50   Input ~ 0
COIL_INJECTOR_OUT
Text GLabel 5000 6200 1    50   Input ~ 0
FUEL_PUMP_OUT
Text GLabel 5100 6200 1    50   Input ~ 0
CLUTCH_ACT_OUT
Text GLabel 5200 6200 1    50   Input ~ 0
ETC_OUT
Text GLabel 5300 6200 1    50   Input ~ 0
SHUTDOWN_OUT
Text GLabel 5400 6200 1    50   Input ~ 0
IGN_SWITCH_OUT
Text GLabel 5500 6200 1    50   Input ~ 0
MCU_UNITS_FEED_OUT
Text GLabel 750  6675 1    50   Input ~ 0
GEAR_ACT_COIL_GND
Wire Wire Line
	750  6675 1000 6675
...
Wire Wire Line
	1000 6675 1000 6500
Text GLabel 4100 6200 1    50   Input ~ 0
GEAR_ACT_COIL_GND
...
P2_Alert
Text GLabel 8475 3150 0    50   Input ~ 0
P1_Alert
Text GLabel 4225 4925 1    50   Input ~ 0
FP_ENABLE_RELAY_SINK
Text GLabel 4325 4925 1    50   Input ~ 0
FP_ENABLE_AUX
Text GLabel 4425 4925 1    50   Input ~ 0
P7_EN_AUX
Text GLabel 4525 4925 1    50   Input ~ 0
P2_EN_AUX
Text GLabel 4625 4925 1    50   Input ~ 0
P4_EN_AUX
Text GLabel 4725 4925 1    50   Input ~ 0
P1_EN_AUX
Text GLabel 4825 4925 1    50   Input ~ 0
P6_EN_ACM
Text GLabel 4925 4925 1    50   Input ~ 0
P6_EN_AUX
Text GLabel 5025 4925 1    50   Input ~ 0
P5_EN_AUX
Text GLabel 5125 4925 1    50   Input ~ 0
CAN_HIGH
Text GLabel 5225 4925 1    50   Input ~ 0
CAN_LOW
Text GLabel 5325 4925 1    50   Input ~ 0
CAN_HIGH
Text GLabel 5425 4925 1    50   Input ~ 0
CAN_LOW
$Sheet
S 4450 825  1200 800 
U 5E5484EE
