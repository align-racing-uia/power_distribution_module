...
F 0 "C1" H 1990 9421 50  0000 L CNN
F 1 "470uf" H 1990 9330 50  0000 L CNN
F 2 "AR_PDM_v1:CAPAE1350X1400N_EEV-FK1V471Q" H 1913 9225 50  0001 C CNN
...
F 0 "C2" H 2590 9421 50  0000 L CNN
F 1 "470uf" H 2590 9330 50  0000 L CNN
F 2 "AR_PDM_v1:CAPAE1350X1400N_EEV-FK1V471Q" H 2513 9225 50  0001 C CNN
F 3 "~" H 2475 9375 50  0001 C CNN
	1    2475 9375
	1    0    0    -1  
$EndComp
$Comp
...
F 0 "C3" H 3215 9421 50  0000 L CNN
F 1 "470uf" H 3215 9330 50  0000 L CNN
F 2 "AR_PDM_v1:CAPAE1350X1400N_EEV-FK1V471Q" H 3138 9225 50  0001 C CNN
...
F 0 "#PWR01" H 1875 9275 50  0001 C CNN
F 1 "GND" H 1880 9352 50  0000 C CNN
F 2 "" H 1875 9525 50  0001 C CNN
F 3 "" H 1875 9525 50  0001 C CNN
	1    1875 9525
	1    0    0    -1  
$EndComp
$Comp
...
F 0 "#PWR02" H 2475 9275 50  0001 C CNN
F 1 "GND" H 2480 9352 50  0000 C CNN
F 2 "" H 2475 9525 50  0001 C CNN
F 3 "" H 2475 9525 50  0001 C CNN
	1    2475 9525
	1    0    0    -1  
$EndComp
$Comp
...
F 0 "#PWR03" H 3100 9275 50  0001 C CNN
F 1 "GND" H 3105 9352 50  0000 C CNN
F 2 "" H 3100 9525 50  0001 C CNN
F 3 "" H 3100 9525 50  0001 C CNN
	1    3100 9525
	1    0    0    -1  
$EndComp
Text Notes 1725 9100 0    50   ~ 0
...
Wire Wire Line
	9750 2225 9650 2225
Text GLabel 9975 3675 2    50   Input ~ 0
FP_ENABLE_ACM
...
FUEL_PUMP_Fault
Text GLabel 9975 4000 2    50   Input ~ 0
vcc_5v
Text GLabel 9975 3875 2    50   Input ~ 0
SDA
Text GLabel 9975 3775 2    50   Input ~ 0
SLC
...
P1_EN_ACM
Text GLabel 1775 9225 0    50   Input ~ 0
V+12V
Text GLabel 6050 8700 1    50   Input ~ 0
V+12V
...
U 1 1 5E2F07B8
P 1650 8325
F 0 "J1" V 1522 8405 50  0000 L CNN
F 1 "S_T_?" V 1613 8405 50  0000 L CNN
F 2 "AR_PDM_v1:Wurth_74655095R_Screw_Post" H 1650 8325 50  0001 C CNN
...
Wire Wire Line
	7900 1275 8000 1275
$Sheet
S 8150 2800 1825 1275
U 5E1AEC18
F0 "Port_Expander" 50
F1 "Port_Expander.sch" 50
F2 "SLC" I R 9975 3775 50 
F3 "SDA" I R 9975 3875 50 
F4 "VCC_5v" I R 9975 4000 50 
F5 "COIL_INJECTOR_Fault" I L 8150 2900 50 
F6 "FUEL_PUMP_Fault" I L 8150 3000 50 
F7 "P7_Fault" I L 8150 3100 50 
F8 "P6_Fault" I L 8150 3200 50 
F9 "P5_Fault" I L 8150 3300 50 
F10 "P4_Fault" I L 8150 3400 50 
F11 "P3_Fault" I L 8150 3500 50 
F12 "P2_Fault" I L 8150 3600 50 
F13 "P1_Fault" I L 8150 3700 50 
F14 "FP_ENABLE_ACM" O R 9975 3675 50 
...
Status_3
Text GLabel 8150 3825 0    50   Input ~ 0
Status_1
Text GLabel 8150 3925 0    50   Input ~ 0
Status_2
Text GLabel 8150 4025 0    50   Input ~ 0
Status_3
$Comp
L AR20_PDM_v1-rescue:C-Device C?
U 1 1 5EE38514
P 6050 9200
AR Path="/5DA89415/5EE38514" Ref="C?"  Part="1" 
AR Path="/5DEB10A1/5EE38514" Ref="C?"  Part="1" 
AR Path="/5DEB20EA/5EE38514" Ref="C?"  Part="1" 
AR Path="/5E0E4725/5EE38514" Ref="C?"  Part="1" 
AR Path="/5E0E4A93/5EE38514" Ref="C?"  Part="1" 
AR Path="/5E0E4EB5/5EE38514" Ref="C?"  Part="1" 
AR Path="/5E0E5304/5EE38514" Ref="C?"  Part="1" 
AR Path="/5E0E594B/5EE38514" Ref="C?"  Part="1" 
AR Path="/5E0E607C/5EE38514" Ref="C?"  Part="1" 
AR Path="/5E0FB5C8/5EE38514" Ref="C?"  Part="1" 
AR Path="/5E0FBBBD/5EE38514" Ref="C?"  Part="1" 
AR Path="/5E0FC3A2/5EE38514" Ref="C?"  Part="1" 
...
U 1 1 5EE3851A
P 6050 9400
AR Path="/5DA89415/5EE3851A" Ref="#PWR?"  Part="1" 
AR Path="/5DEB10A1/5EE3851A" Ref="#PWR?"  Part="1" 
AR Path="/5DEB20EA/5EE3851A" Ref="#PWR?"  Part="1" 
AR Path="/5E0E4725/5EE3851A" Ref="#PWR?"  Part="1" 
AR Path="/5E0E4A93/5EE3851A" Ref="#PWR?"  Part="1" 
AR Path="/5E0E4EB5/5EE3851A" Ref="#PWR?"  Part="1" 
AR Path="/5E0E5304/5EE3851A" Ref="#PWR?"  Part="1" 
AR Path="/5E0E594B/5EE3851A" Ref="#PWR?"  Part="1" 
AR Path="/5E0E607C/5EE3851A" Ref="#PWR?"  Part="1" 
AR Path="/5E0FB5C8/5EE3851A" Ref="#PWR?"  Part="1" 
AR Path="/5E0FBBBD/5EE3851A" Ref="#PWR?"  Part="1" 
AR Path="/5E0FC3A2/5EE3851A" Ref="#PWR?"  Part="1" 
...
U 1 1 5EE38522
P 6050 8850
AR Path="/5DA89415/5EE38522" Ref="R?"  Part="1" 
AR Path="/5DEB10A1/5EE38522" Ref="R?"  Part="1" 
AR Path="/5DEB20EA/5EE38522" Ref="R?"  Part="1" 
AR Path="/5E0E4725/5EE38522" Ref="R?"  Part="1" 
AR Path="/5E0E4A93/5EE38522" Ref="R?"  Part="1" 
AR Path="/5E0E4EB5/5EE38522" Ref="R?"  Part="1" 
AR Path="/5E0E5304/5EE38522" Ref="R?"  Part="1" 
AR Path="/5E0E594B/5EE38522" Ref="R?"  Part="1" 
AR Path="/5E0E607C/5EE38522" Ref="R?"  Part="1" 
AR Path="/5E0FB5C8/5EE38522" Ref="R?"  Part="1" 
AR Path="/5E0FBBBD/5EE38522" Ref="R?"  Part="1" 
AR Path="/5E0FC3A2/5EE38522" Ref="R?"  Part="1" 
...
V+12V
Text Notes 5700 10000 0    50   ~ 0
Snubber to prevent,\nOscillations on VS line.\nApplication note; \nintroduction to PROFET, page 12
Wire Wire Line
...
F 1 "1k" H 12670 1530 50  0000 L CNN
...
F 1 "1k" H 12670 2180 50  0000 L CNN
...
P6_OUT
$Comp
L AR20_PDM_v1-rescue:P-MOS-SIRA99DP-T1-GE3 U38
U 1 1 5F0A5F1B
P 2900 7375
F 0 "U38" V 3151 6875 50  0000 C CNN
F 1 "P-MOS-SIRA99DP-T1-GE3" V 3060 6875 50  0000 C CNN
F 2 "AR_PDM_v1:P-MOS-SIRA99DP-T1-GE3" H 2900 7475 50  0001 C CNN
F 3 "" H 2900 7475 50  0001 C CNN
	1    2900 7375
	1    0    0    -1  
$EndComp
$Comp
L AR20_PDM_v1-rescue:P-MOS-SIRA99DP-T1-GE3 U39
U 1 1 5F0B5227
P 3525 7375
F 0 "U39" V 3776 6875 50  0000 C CNN
F 1 "P-MOS-SIRA99DP-T1-GE3" V 3685 6875 50  0000 C CNN
F 2 "AR_PDM_v1:P-MOS-SIRA99DP-T1-GE3" H 3525 7475 50  0001 C CNN
F 3 "" H 3525 7475 50  0001 C CNN
	1    3525 7375
	1    0    0    -1  
$EndComp
$Comp
L AR20_PDM_v1-rescue:P-MOS-SIRA99DP-T1-GE3 U40
U 1 1 5F0B96FA
P 4125 7375
F 0 "U40" V 4376 6875 50  0000 C CNN
F 1 "P-MOS-SIRA99DP-T1-GE3" V 4285 6875 50  0000 C CNN
F 2 "AR_PDM_v1:P-MOS-SIRA99DP-T1-GE3" H 4125 7475 50  0001 C CNN
F 3 "" H 4125 7475 50  0001 C CNN
	1    4125 7375
	1    0    0    -1  
$EndComp
$Comp
L AR20_PDM_v1-rescue:P-MOS-SIRA99DP-T1-GE3 U41
U 1 1 5F0BC800
P 4750 7375
F 0 "U41" V 5001 6875 50  0000 C CNN
F 1 "P-MOS-SIRA99DP-T1-GE3" V 4910 6875 50  0000 C CNN
F 2 "AR_PDM_v1:P-MOS-SIRA99DP-T1-GE3" H 4750 7475 50  0001 C CNN
F 3 "" H 4750 7475 50  0001 C CNN
	1    4750 7375
	1    0    0    -1  
$EndComp
$Comp
L AR20_PDM_v1-rescue:P-MOS-SIRA99DP-T1-GE3 U37
U 1 1 5F0CB634
P 2275 7375
F 0 "U37" V 2526 6875 50  0000 C CNN
F 1 "P-MOS-SIRA99DP-T1-GE3" V 2435 6875 50  0000 C CNN
F 2 "AR_PDM_v1:P-MOS-SIRA99DP-T1-GE3" H 2275 7475 50  0001 C CNN
F 3 "" H 2275 7475 50  0001 C CNN
	1    2275 7375
	1    0    0    -1  
$EndComp
Wire Wire Line
...
$Comp
L AR20_PDM_v1-rescue:D_zener_BZX79-C6V8,113 D63
U 1 1 5F13AC29
P 4175 7025
F 0 "D63" H 4150 7175 50  0000 L CNN
F 1 "D_zener_BZX79-C6V8,113" H 3775 6900 50  0000 L CNN
F 2 "AR_PDM_v1:D_DO-35_BZX79-C6V8,113" H 4175 7025 50  0001 C CNN
...
U 1 1 5F18113D
P 1700 7450
AR Path="/5DA89415/5F18113D" Ref="R?"  Part="1" 
AR Path="/5DEB10A1/5F18113D" Ref="R?"  Part="1" 
AR Path="/5DEB20EA/5F18113D" Ref="R?"  Part="1" 
AR Path="/5E0E4725/5F18113D" Ref="R?"  Part="1" 
AR Path="/5E0E4A93/5F18113D" Ref="R?"  Part="1" 
AR Path="/5E0E4EB5/5F18113D" Ref="R?"  Part="1" 
AR Path="/5E0E5304/5F18113D" Ref="R?"  Part="1" 
AR Path="/5E0E594B/5F18113D" Ref="R?"  Part="1" 
AR Path="/5E0E607C/5F18113D" Ref="R?"  Part="1" 
AR Path="/5E0FB5C8/5F18113D" Ref="R?"  Part="1" 
AR Path="/5E0FBBBD/5F18113D" Ref="R?"  Part="1" 
AR Path="/5E0FC3A2/5F18113D" Ref="R?"  Part="1" 
AR Path="/5E0FCFDC/5F18113D" Ref="R?"  Part="1" 
AR Path="/5E0FDCCC/5F18113D" Ref="R?"  Part="1" 
AR Path="/5E10174B/5F18113D" Ref="R?"  Part="1" 
AR Path="/5F18113D" Ref="R129"  Part="1" 
F 0 "R129" H 1770 7496 50  0000 L CNN
F 1 "1k" H 1770 7405 50  0000 L CNN
F 2 "Resistor_SMD:R_0603_1608Metric" V 1630 7450 50  0001 C CNN
...
U 1 1 5F186018
P 1700 7650
AR Path="/5DA89415/5F186018" Ref="#PWR?"  Part="1" 
AR Path="/5DEB10A1/5F186018" Ref="#PWR?"  Part="1" 
AR Path="/5DEB20EA/5F186018" Ref="#PWR?"  Part="1" 
AR Path="/5E0E4725/5F186018" Ref="#PWR?"  Part="1" 
AR Path="/5E0E4A93/5F186018" Ref="#PWR?"  Part="1" 
AR Path="/5E0E4EB5/5F186018" Ref="#PWR?"  Part="1" 
AR Path="/5E0E5304/5F186018" Ref="#PWR?"  Part="1" 
AR Path="/5E0E594B/5F186018" Ref="#PWR?"  Part="1" 
AR Path="/5E0E607C/5F186018" Ref="#PWR?"  Part="1" 
AR Path="/5E0FB5C8/5F186018" Ref="#PWR?"  Part="1" 
AR Path="/5E0FBBBD/5F186018" Ref="#PWR?"  Part="1" 
AR Path="/5E0FC3A2/5F186018" Ref="#PWR?"  Part="1" 
AR Path="/5E0FCFDC/5F186018" Ref="#PWR?"  Part="1" 
AR Path="/5E0FDCCC/5F186018" Ref="#PWR?"  Part="1" 
AR Path="/5E10174B/5F186018" Ref="#PWR?"  Part="1" 
AR Path="/5F186018" Ref="#PWR0169"  Part="1" 
F 0 "#PWR0169" H 1700 7400 50  0001 C CNN
