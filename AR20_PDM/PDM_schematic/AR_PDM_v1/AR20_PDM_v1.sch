...
P7_EN_AUX
Text GLabel 12125 6775 1    50   Input ~ 0
FP_ENABLE_AUX
...
COIL_INJECTOR_OUT
Text GLabel 13300 7750 1    50   Input ~ 0
P1_OUT
Text GLabel 13400 7750 1    50   Input ~ 0
P2_OUT
Text GLabel 13500 7750 1    50   Input ~ 0
P3_OUT
Text GLabel 13600 7750 1    50   Input ~ 0
P4_OUT
Text GLabel 13700 7750 1    50   Input ~ 0
P5_OUT
Text GLabel 13800 7750 1    50   Input ~ 0
P6_OUT
Text GLabel 13900 7750 1    50   Input ~ 0
P7_OUT
$Comp
L AR20_PDM_v1-rescue:GND-power #PWR?
U 1 1 5E117EF0
...
F 0 "#PWR09" H 11775 7425 50  0001 C CNN
...
F 2 "AR_PDM_v1:ACM_2020_Footprint" H 14375 3125 50  0001 C CNN
...
F 0 "#PWR012" H 15175 1025 50  0001 C CNN
...
F 0 "#PWR011" H 15175 875 50  0001 C CNN
...
F 0 "#PWR010" H 15175 575 50  0001 C CNN
...
F 0 "#PWR013" H 15175 1325 50  0001 C CNN
F 1 "GND" V 15175 1375 50  0000 C CNN
F 2 "" H 15175 1575 50  0001 C CNN
...
F 0 "#PWR08" H 13625 1775 50  0001 C CNN
...
$EndSheet
Text GLabel 11875 6850 1    50   Input ~ 0
FP_ENABLE_RELAY_SINK
Wire Wire Line
...
AR Path="/5E2C8E2C" Ref="#PWR0136"  Part="1" 
F 0 "#PWR0136" H 10275 7425 50  0001 C CNN
...
AR Path="/5E2C5A37" Ref="#PWR0135"  Part="1" 
F 0 "#PWR0135" H 10375 7425 50  0001 C CNN
...
AR Path="/5E2BF009" Ref="#PWR0134"  Part="1" 
F 0 "#PWR0134" H 10475 7425 50  0001 C CNN
...
U 1 1 5E344AEE
P 12325 1700
AR Path="/5DA89415/5E344AEE" Ref="R_sense?"  Part="1" 
AR Path="/5DEB10A1/5E344AEE" Ref="R_sense?"  Part="1" 
AR Path="/5DEB20EA/5E344AEE" Ref="R_sense?"  Part="1" 
AR Path="/5E0E4725/5E344AEE" Ref="R_sense?"  Part="1" 
AR Path="/5E0E4A93/5E344AEE" Ref="R_sense?"  Part="1" 
AR Path="/5E0E4EB5/5E344AEE" Ref="R_sense?"  Part="1" 
AR Path="/5E0E5304/5E344AEE" Ref="R_sense?"  Part="1" 
AR Path="/5E0E594B/5E344AEE" Ref="R_sense?"  Part="1" 
AR Path="/5E0E607C/5E344AEE" Ref="R_sense?"  Part="1" 
AR Path="/5E0FB5C8/5E344AEE" Ref="R_sense?"  Part="1" 
AR Path="/5E0FBBBD/5E344AEE" Ref="R_sense?"  Part="1" 
AR Path="/5E0FC3A2/5E344AEE" Ref="R_sense?"  Part="1" 
AR Path="/5E0FCFDC/5E344AEE" Ref="R_sense?"  Part="1" 
AR Path="/5E0FDCCC/5E344AEE" Ref="R_sense?"  Part="1" 
AR Path="/5E10174B/5E344AEE" Ref="R_sense?"  Part="1" 
AR Path="/5E344AEE" Ref="R_sense1"  Part="1" 
F 0 "R_sense1" H 12395 1746 50  0000 L CNN
...
AR Path="/5E344AF4" Ref="#PWR0137"  Part="1" 
F 0 "#PWR0137" H 12325 1850 50  0001 C CNN
...
U 1 1 5E344B03
P 11775 1750
AR Path="/5DA89415/5E344B03" Ref="C_sense?"  Part="1" 
AR Path="/5DEB10A1/5E344B03" Ref="C_sense?"  Part="1" 
AR Path="/5DEB20EA/5E344B03" Ref="C_sense?"  Part="1" 
AR Path="/5E0E4725/5E344B03" Ref="C_sense?"  Part="1" 
AR Path="/5E0E4A93/5E344B03" Ref="C_sense?"  Part="1" 
AR Path="/5E0E4EB5/5E344B03" Ref="C_sense?"  Part="1" 
AR Path="/5E0E5304/5E344B03" Ref="C_sense?"  Part="1" 
AR Path="/5E0E594B/5E344B03" Ref="C_sense?"  Part="1" 
AR Path="/5E0E607C/5E344B03" Ref="C_sense?"  Part="1" 
AR Path="/5E0FB5C8/5E344B03" Ref="C_sense?"  Part="1" 
AR Path="/5E0FBBBD/5E344B03" Ref="C_sense?"  Part="1" 
AR Path="/5E0FC3A2/5E344B03" Ref="C_sense?"  Part="1" 
AR Path="/5E0FCFDC/5E344B03" Ref="C_sense?"  Part="1" 
AR Path="/5E0FDCCC/5E344B03" Ref="C_sense?"  Part="1" 
AR Path="/5E10174B/5E344B03" Ref="C_sense?"  Part="1" 
AR Path="/5E344B03" Ref="C_sense1"  Part="1" 
F 0 "C_sense1" H 11890 1796 50  0000 L CNN
...
AR Path="/5E344B09" Ref="#PWR0138"  Part="1" 
F 0 "#PWR0138" H 11775 1850 50  0001 C CNN
...
Wire Wire Line
	13650 825  13625 825 
Wire Wire Line
	12725 825  12725 1500
Connection ~ 13625 825 
Wire Wire Line
	13625 825  12725 825 
Wire Wire Line
	12325 1500 12725 1500
